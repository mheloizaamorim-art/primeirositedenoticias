...
const container = document.getElementById("container_detalhe"); //é a nosa div

const params = new URLSearchParams(window.location.search); //é uma classe que te permite ler query string.
